...
class MelodiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create melody" do
    assert_difference('Melody.count') do
      post melodies_url, params: { melody: { lyric_id: @melody.lyric_id, user_id: @melody.user_id } }
    end
  ...
  test "should update melody" do
    patch melody_url(@melody), params: { melody: { lyric_id: @melody.lyric_id, user_id: @melody.user_id } }
